...
#python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="gammaEndcapPlus_sumPt.pdf"   --map=gammaEndcapPlus   --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=0,80    --rebin=0 --yZoomRange=-3,3 --xZoomRange=0,100  
...
python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="egammaHFPlus_sumPt.pdf"      --map=egammaHFPlus      --mode=$mood --func='((x*(x<60)+60*(x>=60))*[0]+(x*(x<60)+60*(x>=60))**2*[1])' --fitRange=5,150   --rebin=0 --yZoomRange=-4,4 --xZoomRange=0,300  
