...
#python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="hEtaPlus_mult.pdf"          --map=hEtaPlus          --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=15,500   --rebin=0 --yZoomRange=-5,5 --xZoomRange=0,800  
...
#python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="gammaEndcapPlus_mult.pdf"   --map=gammaEndcapPlus   --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=0,80    --rebin=0 --yZoomRange=-3,3 --xZoomRange=0,100  
...
#python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="hHFMinus_mult.pdf"          --map=hHFMinus          --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=0,250   --rebin=0 --yZoomRange=-4,4 --xZoomRange=0,300  
python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="egammaHFPlus_sumPt.pdf"      --map=egammaHFPlus      --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=0,170   --rebin=0 --yZoomRange=-4,4 --xZoomRange=0,300  
python multiplicityFit.py  --textFileName=$outputTextFile --input=$inputTextFile --rootGDir=metPhiCorrInfoWriter --plotoutPutDir=$plotoutPutDirString --plotFileName="egammaHFMinus_sumPt.pdf"     --map=egammaHFMinus     --mode=$mood --func='(x*[0]+x**2*[1])' --fitRange=0,180   --rebin=0 --yZoomRange=-4,4 --xZoomRange=0,300  
echo ")">>$outputTextFile
